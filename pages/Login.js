  ...
  render() {
    return (
      <View style={{ backgroundColor: 'white', flex: 1 }}>
        <Image resizeMode='center' style={{width:200, height: 240,marginLeft:80,marginTop:30,flex:1 }} source={require('./img/67638670_762812224155593_7221336240858071040_n.png')} />
